...
<div class="row">
    ...
    <div class="dropdown-content" style="height:650px;min-width: 340px;margin:-6%">
      <div class="row" >
        <div class="column" style="border-right:1px solid grey;padding:0%;">
        <div style="text-align:center;align-content: center;background-color: red;width:100%;height: 50%;">Congrats your order is eleigible for free shipping</div>
        <div id="cart">
          ADDED ITEMS
        </div>  
        <div style="text-align:center;cursor:pointer;align-content: center;background-color: rgba(132, 134, 236, 0.664);width:100%;height: 50%;margin-bottom: 0%;"><h2>proceed to payment</h2></div>
      </div>
